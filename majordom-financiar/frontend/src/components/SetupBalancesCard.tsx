...
export default function SetupBalancesCard({ accounts, onComplete }: Props) {
  ...
  return (
    <Card label="Enter your real account balances" className="max-w-[85%] rounded-bl-sm">
      <div className="space-y-3">
        <p className="text-token-ink-3 text-xs">Check your banking app and correct where needed — not sure about one? Skip it, no changes until you investigate</p>
            ...
            <div key={acc.id} className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className={`bg-token-paper border border-token-line rounded-lg px-2 py-1 w-24 text-sm text-right font-mono tabular-nums focus:outline-none focus:border-token-brand transition-colors ${
            ...
            <div key={idx} className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="w-20 bg-token-paper border border-token-line rounded-lg px-2 py-1 text-token-ink text-sm text-right font-mono tabular-nums focus:outline-none focus:border-token-brand transition-colors"
                />
              </div>
