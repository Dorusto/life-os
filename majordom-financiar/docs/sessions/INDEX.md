...
| [W27](2026-W27.md) | 2026-07-03 | #138: vehicle-manager extracted as independent FastAPI service; 4 real bugs found during audit/live testing with real Fuelio data | tools/vehicle-manager/ (new), core/vehicle_client/ (new), tools/finance/vehicle.py, api/{fuelio_import,receipts,vehicle_proposals,vehicle_log_actions,vehicle_reminder_actions}.py, services/{notification_service,receipt_service}.py, config/settings.py, memory/database.py, docker-compose.yml, Home.tsx |
