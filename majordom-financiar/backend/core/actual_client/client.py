...
from backend.core.finance.transaction_utils import financial_id, rule_match_prefix
...
class ActualBudgetClient:
    ...
    async def get_fire_status(self) -> dict:
        ...
        Returns the calc_fire() dict (fire_portfolio, fire_target, fire_pct, etc.).
        """
        def _get():
            from actual.queries import get_accounts, get_transactions
        ...
        def _import():
            ...
            with self._get_actual() as actual:
                ...
                for row in rows:
                    ...
                    fid = financial_id(tx_date.isoformat(), row["merchant"], row["amount"])
                    ...
                    if row["transfer_to_account_id"]:
                        ...
                        src_tx.cleared = True
                        dst_tx.financial_id = financial_id(tx_date.isoformat(), row["merchant"], -row["amount"])
                        dst_tx.cleared = True
